...
// The live coordination loop receives all three agent recommendations (R10 §7):
// A2C (emergency), DQN (efficiency), PPO (congestion). Rendered left-to-right in
// the order they enter the priority ladder.

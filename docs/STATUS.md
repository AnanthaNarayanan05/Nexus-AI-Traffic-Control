...
P2 scenarios + P3 replay + inspectors + P4 export) + `vitest` (84, incl. presentation mode, live
metric trends, event timeline) green; `npm run build` + `eslint` + `tsc -b` clean.

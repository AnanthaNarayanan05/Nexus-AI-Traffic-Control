...
P2 scenarios + P3 replay + inspectors + P4 export) + `vitest` (77, incl. presentation mode + live
metric trends) green; `npm run build` + `eslint` + `tsc -b` clean.

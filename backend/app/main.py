...
def create_app() -> FastAPI:
    app = FastAPI(
        ...
        version="0.1.0",
        description=(
            "Three objective-specific RL agents (A2C emergency priority, DQN fuel/emission/"
            "safety, PPO congestion) coordinated at the signal level, with an authoritative "
